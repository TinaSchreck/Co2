    ...
    if selected_model_name:
        ...
        <div style="display:flex">
            <div style="flex:50%;padding-right:10px;">
                {y_test_df.head(11).to_html()}
            </div>
            <div style="flex:50%">
                {y_pred_df.head(11).to_html()}
            </div>
        </div>
